...
```
#### Path Parameters
<AutoTypeTable path="content/docs/cowriter/types/cowriter-websocket.ts" name="PathParamsTranscriptionRequest" />
---
...
<AutoTypeTable path="content/docs/cowriter/types/cowriter-websocket.ts" name="LiveTranscriptionResponse" />
