...
| POST   | `/session/{session_id}/findings` | Add a finding to the session. |
| GET   | `/session/{session_id}`            | Get all findings. |
| Transcribe   | `/session/{session_id}/transcribe`            | Transcribe audio. |
| Events   | `/session/{session_id}/events`            | Receive events. |
...
href="/cowriter/addFinding" title="Add finding"/>
    <Card
      className="flex items-center gap-2 group transition-all duration-300 hover:[&>div]:bg-fd-info [&>div]:transition-all [&>div]:duration-300"
...
/>
    ...
    <Card
      className="flex items-center gap-2 group transition-all duration-300 hover:[&>div]:bg-fd-info [&>div]:transition-all [&>div]:duration-300"
href="/cowriter/sse" title="NotificationsSSE"
/>
