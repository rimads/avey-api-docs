    ...
    "validation_results": [
      {
        ...
        "medical_necessity": {
          ...
          "rationale": "Lisinopril is FDA-approved for hypertension",
          "warnings": []
        },
        "drug_interactions": [],
        "dosage_validation": {
        ...
        "overall_assessment": {
          "risk_level": "low",
          "recommendation": "Appropriate for this patient",
          "monitoring_required": ["Blood pressure", "Renal function"]
        }
      }
    ],
    "summary": {
      "total_medications": 1,
      "medications_with_warnings": 0,
      "high_risk_interactions": 0,
...
### Multiple Medications with Interactions Response
    ...
    "validation_results": [
      {
        ...
        "medical_necessity": {
          ...
          "confidence_score": 0.95,
          "supporting_diagnoses": ["I10"],
          "rationale": "Appropriate for hypertension management"
        },
        "drug_interactions": [
          {
            "interacting_medication": "00071-0220-01",
        ...
        "overall_assessment": {
          "risk_level": "moderate",
          "recommendation": "Appropriate with monitoring",
          "monitoring_required": [
            "Blood pressure",
            "Renal function",
            "Muscle symptoms"
      ...
      {
        "ndc": "00071-0220-01",
        "medication_name": "Atorvastatin 20 MG Oral Tablet",
        "medical_necessity": {
          "is_appropriate": true,
          "confidence_score": 0.9,
          "supporting_diagnoses": ["I10", "E11.9"],
          "rationale": "Appropriate for cardiovascular risk reduction in diabetes"
        },
        "drug_interactions": [
          {
            "interacting_medication": "00071-1010-01",
            "interaction_type": "moderate",
            "severity": "moderate",
            "description": "Increased risk of myopathy when combined with ACE inhibitors",
            "recommendation": "Monitor for muscle pain and weakness",
            "evidence_level": "moderate"
          }
        ],
...
### Pregnancy Contraindication Response
    ...
    "validation_results": [
      {
        ...
        "medical_necessity": {
          ...
          "warnings": ["This medication can cause fetal harm"]
        },
        "drug_interactions": [],
        "dosage_validation": {
          "is_appropriate": false,
          "recommendation": "Do not prescribe during pregnancy"
        },
        "contraindications": {
          "absolute": [],
          "relative": [
            {
              "condition": "Pregnancy",
              "severity": "high",
              "description": "ACE inhibitors can cause fetal harm, especially in second and third trimesters",
        ...
        "overall_assessment": {
          "risk_level": "high",
          "recommendation": "Contraindicated in pregnancy - consider alternative therapy",
          "monitoring_required": ["Fetal monitoring if already exposed"]
        }
      }
    ],
    "summary": {
