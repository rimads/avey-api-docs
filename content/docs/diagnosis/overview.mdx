...
## API Reference
- [Create Session](/diagnosis/new_diagnosis_ddx_diagnose__post)
- [Continue Session](/diagnosis/update_session_ddx_session__session_id__post)
- [Diagnose](/diagnosis/new_diagnosis_ddx_diagnose__post)
