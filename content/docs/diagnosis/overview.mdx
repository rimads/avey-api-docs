...
href="/diagnosis/new_session__post" title="Create a session"/>
    <Card

      className="flex items-center gap-2 group transition-all duration-300 hover:[&>div]:bg-fd-info [&>div]:transition-all [&>div]:duration-300"

href="/diagnosis/update_session__session_id__post" title="Continue a session"/>
    <Card
      className="flex items-center gap-2 group transition-all duration-300 hover:[&>div]:bg-fd-info [&>div]:transition-all [&>div]:duration-300"
href="/diagnosis/new_diagnosis_diagnosis__post" title="Diagnose"
/>
</Cards>
