...
```bash
curl -X POST https://api.avey.com/v1/cpt-coding \
...
### Multiple Procedures with Context
    ...
    "procedures": [
      {
        ...
        "context": "Patient with shortness of breath and chest pain"
      },
      {
        "description": "EKG",
        "context": "Routine cardiac evaluation"
      },
      {
        "description": "Blood work",
        "context": "Complete metabolic panel and CBC"
      }
    ],
...
curl -X POST https://api.avey.com/v1/cpt-coding \
  ...
  -d '{
    "procedures": [
      {
        "description": "Right knee arthroscopy with partial meniscectomy and chondroplasty"
      }
    ],
...
```json
{
  ...
  "data": {
    "results": [
      {
        "input_description": "Laparoscopic cholecystectomy",
        "cpt_codes": [
          {
            "code": "47562",
